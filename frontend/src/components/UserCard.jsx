...
function UserCard({user}) {
    ...
    const handleConnetionRequest = async () =>{

    }

    return (
        <div className='p-4 pt-12 flex flex-col justify-between w-72 shadow border border-gray-200 rounded-md'>
            ...
            <div className='flex items-center justify-center gap-2 mt-4 text-xs text-gray-600'>
                <div className='flex items-center gap-1 border border-gray-300 t=rounded-full px-3 py-1'>
            ...
            <div className='flex mt-4 gap-2'>
                ...
                justify-center items-center gap-2 bg-linear-to-r
                ...
                <button 
                onClick={handleConnetionRequest}
                className='flex items-center justify-center w-16 border text-slate-500 group rounded-md cursor-pointer active:scale-95 transition'>
                    {
                        ...
                        <MessageCircle className='w-5 h-5 group-hover:scal-105 transition'/> 
                        :
