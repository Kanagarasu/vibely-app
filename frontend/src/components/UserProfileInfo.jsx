...
function UserProfileInfo({user,posts,profileId,setShowEdit}) {
  return (
    <div className='relative py-4 px-6 mdLpx-8 bg-white'>
        <div className='flex flex-col md:flex-row items-start gap-6'>
            ...
            <div className='w-full pt-16 md:pt-0 md:pl-36'>
                <div className='flex flex-col md:flex-row items-start justify-between '>
                    ...
                    {/* if user is not on others profile that means he is 
                    opening his profile so we will give edit button */}
                    {!profileId && 
                ...
                <div className='flex flex-wrap items-center gap-x-6 gap-y-2 text-sm text-gray-500 mt-4'>
                    ...
                    <span className='flex items-center gap-1.5'>
                        ...
                        Joined <span className='font-medum'>{moment(user.craetedAt).fromNow()}</span>
                    </span>
                </div>
